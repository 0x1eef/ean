...
fn test_zero() {
  ...
  assert_eq!('\u{0660}', numeral.digits[0].to_char);
}
...
fn test_one() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0661}', numeral.digits[0].to_char);
}
...
fn test_two() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0662}', numeral.digits[0].to_char);
}
...
fn test_three() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0663}', numeral.digits[0].to_char);
}
...
fn test_five() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0665}', numeral.digits[0].to_char);
}
...
fn test_six() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0666}', numeral.digits[0].to_char);
}
...
fn test_eight() {
  ...
  assert_eq!(1, numeral.digits.len());
  assert_eq!('\u{0668}', numeral.digits[0].to_char);
}
